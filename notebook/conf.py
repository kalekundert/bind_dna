...
htmlhelp_basename = 'cdna_ligation'
...
latex_documents = [ #
    (master_doc, 'cdna_ligation.tex', 'cDNA ligation',
     'Kale Kundert', 'manual'),
]
...
man_pages = [ #
    (master_doc, 'cdna_ligation', 'cDNA ligation',
     [author], 1)
]
...
texinfo_documents = [ #
    (master_doc, 'cdna_ligation', 'cDNA ligation',
     author, 'cdna_ligation', 'One line description of project.',
     'Miscellaneous'),
]
